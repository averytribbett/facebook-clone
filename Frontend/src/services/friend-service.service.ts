...
export class FriendServiceService {
  ...
  public getFriendList(username: string): Observable<FriendModel[]> { // Observable<UserModel[]> 
    return this.httpClient.get<FriendModel[]>("api/friends/findFriendList/" + username);
  }
